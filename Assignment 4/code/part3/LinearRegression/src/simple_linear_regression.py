...
if __name__ == '__main__':
    ...
    parser.add_argument('-m', '--metric', default='MSE', choices=['MSE', 'RMSE', 'MAE', 'R2'])
    parser.add_argument('-o', '--optimizer', default='BGD', choices=['BGD', 'PSO', 'MiniBGD'])
    args = parser.parse_args()
    # Settings
    metric_type = args.metric  # MSE, RMSE, MAE, R2
    optimizer_type = args.optimizer  # PSO, BGD
